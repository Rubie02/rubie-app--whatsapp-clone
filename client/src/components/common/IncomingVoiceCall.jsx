...
function IncomingVoiceCall() {
  ...
  return (
    <div className="h-24 w-80 fixed bottom-8 mb-0 right-6 bg-conversation-panel-background
    z-50 rounded-sm flex gap-5 items-center justify-start p-4 text-white drop-shadow-2xl
    border-icon-green border-2 py-14
    ">
      <div>
        <Image 
