...
function SearchMessages() {
  ...
  return (
    <div className="border-conversation-border border-l w-full bg-conversation-panel-background
      flex flex-col z-10 max-h-screen
    ">
      ...
      <div className="overflow-auto custom-scrollbar h-full">
        <div className="flex items-center flex-col w-full">
          ...
          <div className="bg-panel-header-background flex items-center gap-5
        px-3 py-1 rounded-lg flex-grow
      ">
        <div>
          <BiSearchAlt2 
          ...
          <div className="flex flex-col w-full h-full">
          {
            searchedMessages.map((message) => (
              ...
              ">
                ...
                <div className={message.receiverId === currentChatUser.id ? 
                      "text-icon-green" :
                      "text-blue-500"}>
                  {message.message}
                </div>
