...
function VoiceMessage({message}) {
  ...
  return (
    <div className={`flex items-center gap-5 text-white px-4 pr-2 py-4 text-sm rounded-sm
      ...
      <div className="relative">
        ...
        />
          <div className="text-bubble-meta text-[11px] pt-1 flex justify-between
            absolute bottom-[-22px] w-full
          ">
            <span>
              {
                formatTime(isPlaying ? cuurentPlaybackTime : totalDuration)
              }
            </span>
